...
import 'package:rental_car/presentation/pages/car_list_screen.dart';
import 'package:rental_car/presentation/widgets/car_card.dart';
import 'package:rental_car/presentation/widgets/more_card.dart';
          ...
          Padding(
            ...
            child: Row(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    CircleAvatar(radius: 40, backgroundImage: AssetImage('assets/user1.png'),),
                    SizedBox(height: 10,),
                    Text('Myke Butler', style: TextStyle(fontWeight: FontWeight.bold),),
